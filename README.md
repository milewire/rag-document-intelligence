...
- AI-powered answers generated by Claude (Anthropic)
...
├── documents/          # (optional) local document storage
...
4. **Generate** — Claude synthesises a grounded answer from the retrieved document chunks.
